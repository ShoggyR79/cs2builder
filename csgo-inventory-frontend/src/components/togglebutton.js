...
const ToggleButton = ({ side, onToggle }) => {
    ...
    return (
        <div className='flex flex-row sm:flex-col'>
            <h3 className={`text-xl font-bold mb-3 text-white items-center`}>
                {side ? 'T' : 'CT'} <span className='hidden sm:inline ml-1'>Loadout</span></h3>
            <label className="relative inline-flex items-center cursor-pointer ml-2 sm:ml-0">
